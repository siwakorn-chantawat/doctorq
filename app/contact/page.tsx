  ...
  return (
    <Container>
      ...
      <div className="flex flex-col divide-y-2 divide-solid divide-primary-300 gap-4 py-6 px-4 border-2 border-primary-300/95">
        ...
        <GoogleMap />
        <Image src={map} alt="doctorq map" className="pt-4" />
      </div>

      <div className="flex flex-col divide-y-2 divide-solid divide-primary-300 gap-4 py-6 px-4 border-2 border-primary-300/95">
        <div className="flex flex-col gap-2">
          <h4 className="text-xl pb-4">ข้อมูลสำหรับติดต่อ</h4>
          <p>179/1 ม.1 ต.บางขุนกอง อ.บางกรวย จ.นนทบุรี 11130 ประเทศไทย</p>
        </div>
        <div className="flex flex-col gap-4 mt-2">
          <Link
            href={"tel:0639031416"}
            className="border border-primary px-2 py-2"
          >
